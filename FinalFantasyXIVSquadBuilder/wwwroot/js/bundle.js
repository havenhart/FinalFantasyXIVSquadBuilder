...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t5 = text(" / T: ");
    			t6 = text(t6_value);
    			add_location(b, file, 35, 4, 808);
    			add_location(br, file, 35, 24, 828);
    			li.className = "list-group-item squadmember svelte-732llx";
    			toggle_class(li, "selectedmember", ctx.selected);
    			toggle_class(li, "activemember", ctx.active);
    			toggle_class(li, "standbymember", ctx.needsTraining && ctx.active);
    			add_location(li, file, 34, 0, 641);
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((changed.needsTraining || changed.active)) {
    				toggle_class(li, "standbymember", ctx.needsTraining && ctx.active);
    			}
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { memberId = 0, selected = false, active = false, needsTraining = false } = $$props;

    	const writable_props = ['memberId', 'selected', 'active', 'needsTraining'];
    	...
    	$$self.$set = $$props => {
    		...
    		if ('needsTraining' in $$props) $$invalidate('needsTraining', needsTraining = $$props.needsTraining);
    	};
    ...
    class SquadItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["memberId", "selected", "active", "needsTraining"]);
    	}
    ...
    function create_each_block(ctx) {
    	...
    	var squaditem = new SquadItem({
    		...
    		active: ctx.member.active,
    		needsTraining: ctx.needsTraining
    	},
    		$$inline: true
    	});
    	...
    	return {
    		...
    		p: function update(changed, new_ctx) {
    			...
    			if (changed.$squad) squaditem_changes.active = ctx.member.active;
    			if (changed.needsTraining) squaditem_changes.needsTraining = ctx.needsTraining;
    ...
    function create_fragment$1(ctx) {
    	var div2, div0, t0, t1, t2, t3, div1, ul, t4, div3, dl0, dt0, span0, dd0, t6, dl1, dt1, span1, dd1, current;
    	...
    	return {
    		c: function create() {
    			...
    			span0 = element("span");
    			dd0 = element("dd");
    			dd0.textContent = "Success";
    			t6 = space();
    			dl1 = element("dl");
    			dt1 = element("dt");
    			span1 = element("span");
    			dd1 = element("dd");
    			dd1.textContent = "Success after Recommended Training";
    			div0.className = "card-header svelte-46rtyl";
    			add_location(div0, file$1, 59, 4, 975);
    			ul.className = "list-group";
    			add_location(ul, file$1, 61, 2, 1072);
    			div1.className = "card-body svelte-46rtyl";
    			add_location(div1, file$1, 60, 4, 1045);
    			div2.className = "card svelte-46rtyl";
    			add_location(div2, file$1, 58, 0, 951);
    			span0.className = "swatch-success svelte-46rtyl";
    			add_location(span0, file$1, 77, 6, 1431);
    			dt0.className = "svelte-46rtyl";
    			add_location(dt0, file$1, 77, 2, 1427);
    			dd0.className = "svelte-46rtyl";
    			add_location(dd0, file$1, 78, 2, 1476);
    			dl0.className = "svelte-46rtyl";
    			add_location(dl0, file$1, 76, 1, 1419);
    			span1.className = "swatch-training svelte-46rtyl";
    			add_location(span1, file$1, 81, 6, 1517);
    			dt1.className = "svelte-46rtyl";
    			add_location(dt1, file$1, 81, 2, 1513);
    			dd1.className = "svelte-46rtyl";
    			add_location(dd1, file$1, 82, 2, 1563);
    			dl1.className = "svelte-46rtyl";
    			add_location(dl1, file$1, 80, 1, 1505);
    			div3.className = "card legend svelte-46rtyl";
    			add_location(div3, file$1, 75, 0, 1391);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.$squad || changed.selectedID || changed.needsTraining) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { selectedID = -1, activeMembers = [], needsTraining = false } = $$props;

    	const dispatch = createEventDispatcher();

    	const writable_props = ['selectedID', 'activeMembers', 'needsTraining'];
    	Object.keys($$props).forEach(key => {
    ...
    class Squadlist extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["selectedID", "activeMembers", "needsTraining"]);
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t36 = space();
    			b3 = element("b");
    			t37 = text("Recommended Training:");
    			br = element("br");
    			t38 = text(t38_value);
    			div0.className = "card-header svelte-ww1y1e";
    			add_location(div0, file$3, 34, 4, 846);
    			add_location(b0, file$3, 36, 4, 941);
    			label0.htmlFor = "physicalScore";
    			add_location(label0, file$3, 39, 16, 1064);
    			attr(input0, "type", "number");
    			input0.className = "form-control";
    			input0.id = "physicalScore";
    			input0.placeholder = "0";
    			add_location(input0, file$3, 40, 16, 1126);
    			div1.className = "form-group col-md-4";
    			add_location(div1, file$3, 38, 12, 1013);
    			label1.htmlFor = "mentalScore";
    			add_location(label1, file$3, 43, 16, 1319);
    			attr(input1, "type", "number");
    			input1.className = "form-control";
    			input1.id = "mentalScore";
    			input1.placeholder = "0";
    			add_location(input1, file$3, 44, 16, 1377);
    			div2.className = "form-group col-md-4";
    			add_location(div2, file$3, 42, 12, 1268);
    			label2.htmlFor = "tacticalScore";
    			add_location(label2, file$3, 47, 16, 1566);
    			attr(input2, "type", "number");
    			input2.className = "form-control";
    			input2.id = "tacticalScore";
    			input2.placeholder = "0";
    			add_location(input2, file$3, 48, 16, 1628);
    			div3.className = "form-group col-md-4";
    			add_location(div3, file$3, 46, 12, 1515);
    			div4.className = "form-row";
    			add_location(div4, file$3, 37, 8, 977);
    			add_location(b1, file$3, 51, 8, 1782);
    			label3.htmlFor = "physicalScore";
    			add_location(label3, file$3, 54, 16, 1905);
    			attr(input3, "type", "number");
    			input3.className = "form-control";
    			input3.id = "physicalScore";
    			input3.placeholder = "0";
    			add_location(input3, file$3, 55, 16, 1967);
    			div5.className = "form-group col-md-4";
    			add_location(div5, file$3, 53, 12, 1854);
    			label4.htmlFor = "mentalScore";
    			add_location(label4, file$3, 58, 16, 2162);
    			attr(input4, "type", "number");
    			input4.className = "form-control";
    			input4.id = "mentalScore";
    			input4.placeholder = "0";
    			add_location(input4, file$3, 59, 16, 2220);
    			div6.className = "form-group col-md-4";
    			add_location(div6, file$3, 57, 12, 2111);
    			label5.htmlFor = "tacticalScore";
    			add_location(label5, file$3, 62, 16, 2411);
    			attr(input5, "type", "number");
    			input5.className = "form-control";
    			input5.id = "tacticalScore";
    			input5.placeholder = "0";
    			add_location(input5, file$3, 63, 16, 2473);
    			div7.className = "form-group col-md-4";
    			add_location(div7, file$3, 61, 12, 2360);
    			button.className = "btn btn-primary float-right svelte-ww1y1e";
    			add_location(button, file$3, 66, 16, 2665);
    			div8.className = "col-md-12";
    			add_location(div8, file$3, 65, 12, 2617);
    			div9.className = "form-row";
    			add_location(div9, file$3, 52, 8, 1818);
    			add_location(b2, file$3, 69, 8, 2796);
    			label6.htmlFor = "physicalScore";
    			add_location(label6, file$3, 72, 16, 2918);
    			attr(input6, "type", "text");
    			input6.className = "form-control";
    			input6.id = "physicalScore";
    			input6.placeholder = "0";
    			input6.readOnly = true;
    			add_location(input6, file$3, 73, 16, 2980);
    			div10.className = "form-group col-md-4";
    			add_location(div10, file$3, 71, 12, 2867);
    			label7.htmlFor = "mentalScore";
    			add_location(label7, file$3, 76, 16, 3189);
    			attr(input7, "type", "text");
    			input7.className = "form-control";
    			input7.id = "mentalScore";
    			input7.placeholder = "0";
    			input7.readOnly = true;
    			add_location(input7, file$3, 77, 16, 3247);
    			div11.className = "form-group col-md-4";
    			add_location(div11, file$3, 75, 12, 3138);
    			label8.htmlFor = "tacticalScore";
    			add_location(label8, file$3, 80, 16, 3452);
    			attr(input8, "type", "text");
    			input8.className = "form-control";
    			input8.id = "tacticalScore";
    			input8.placeholder = "0";
    			input8.readOnly = true;
    			add_location(input8, file$3, 81, 16, 3514);
    			div12.className = "form-group col-md-4";
    			add_location(div12, file$3, 79, 12, 3401);
    			div13.className = "form-row";
    			add_location(div13, file$3, 70, 8, 2831);
    			add_location(br, file$3, 84, 32, 3708);
    			add_location(b3, file$3, 84, 8, 3684);
    			div14.className = "card-body svelte-ww1y1e";
    			add_location(div14, file$3, 35, 4, 912);
    			div15.className = "card svelte-ww1y1e";
    			add_location(div15, file$3, 33, 0, 822);
    		...
    		m: function mount(target, anchor) {
    			...
    			input6.value = ctx.activeSquadTotals.physical;
    			...
    			input7.value = ctx.activeSquadTotals.mental;
    			...
    			input8.value = ctx.activeSquadTotals.tactical;
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.activeSquadTotals && (input6.value !== ctx.activeSquadTotals.physical)) input6.value = ctx.activeSquadTotals.physical;
    			if (changed.activeSquadTotals && (input7.value !== ctx.activeSquadTotals.mental)) input7.value = ctx.activeSquadTotals.mental;
    			if (changed.activeSquadTotals && (input8.value !== ctx.activeSquadTotals.tactical)) input8.value = ctx.activeSquadTotals.tactical;

    			if ((changed.activeSquadTotals) && t38_value !== (t38_value = ctx.activeSquadTotals.training)) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
        ...
        let { activeSquadTotals = { physical: 0, mental: 0, tactical: 0, training: 'None' } } = $$props;
    	...
    	const writable_props = ['activeSquadTotals'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<SquadCalculator> was created with unknown prop '${key}'`);
    	});
    	...
    	function input6_input_handler() {
    		activeSquadTotals.physical = this.value;
    		$$invalidate('activeSquadTotals', activeSquadTotals);
    	}

    	function input7_input_handler() {
    		activeSquadTotals.mental = this.value;
    		$$invalidate('activeSquadTotals', activeSquadTotals);
    	}

    	function input8_input_handler() {
    		activeSquadTotals.tactical = this.value;
    		$$invalidate('activeSquadTotals', activeSquadTotals);
    	}

    	$$self.$set = $$props => {
    		if ('activeSquadTotals' in $$props) $$invalidate('activeSquadTotals', activeSquadTotals = $$props.activeSquadTotals);
    	};
    ...
    class SquadCalculator extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, ["activeSquadTotals"]);
    	}

    	get activeSquadTotals() {
    		throw new Error("<SquadCalculator>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set activeSquadTotals(value) {
    		throw new Error("<SquadCalculator>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	var squadcalculator = new SquadCalculator({
    		props: { activeSquadTotals: ctx.activeSquadTotals },
    		$$inline: true
    	});
    	squadcalculator.$on("calculate", ctx.calculateSquad);
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$4, 90, 1, 2060);
    			div1.className = "col-8";
    			add_location(div1, file$4, 93, 1, 2222);
    			div2.className = "row";
    			add_location(div2, file$4, 89, 0, 2041);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.needsTraining) squadlist_changes.needsTraining = ctx.needsTraining;
    			...
    			var squadcalculator_changes = {};
    			if (changed.activeSquadTotals) squadcalculator_changes.activeSquadTotals = ctx.activeSquadTotals;
    			squadcalculator.$set(squadcalculator_changes);
    		},
    	...
    	function calculateSquad(event){
    		...
    		.then(data => {
    				if(data.errorMessage){
    					$$invalidate('needsTraining', needsTraining = true);
    					$$invalidate('activeSquadTotals', activeSquadTotals = { 
    						physical: 0, 
    						mental: 0, 
    						tactical: 0, 
    					...
    					$$invalidate('needsTraining', needsTraining = !(data.training === 'None'));
    					$$invalidate('activeSquadTotals', activeSquadTotals = { 
