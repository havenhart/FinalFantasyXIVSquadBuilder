...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.mental && (input2.value !== ctx.mental)) input2.value = ctx.mental;
    			if (changed.tactical && (input3.value !== ctx.tactical)) input3.value = ctx.tactical;
    		},
    ...
    function create_fragment$3(ctx) {
    	var div15, div0, t1, div14, b0, t3, div4, div1, label0, t5, input0, input0_value_value, t6, div2, label1, t8, input1, input1_value_value, t9, div3, label2, t11, input2, input2_value_value, t12, b1, t14, div9, div5, label3, t16, input3, input3_value_value, t17, div6, label4, t19, input4, input4_value_value, t20, div7, label5, t22, input5, input5_value_value, t23, div8, button, t25, b2, t27, div13, div10, label6, t29, input6, t30, div11, label7, t32, input7, t33, div12, label8, t35, input8, t36, b3;
    	...
    	return {
    		c: function create() {
    			...
    			div0.className = "card-header svelte-ww1y1e";
    			add_location(div0, file$3, 25, 4, 517);
    			add_location(b0, file$3, 27, 4, 612);
    			label0.htmlFor = "physicalScore";
    			add_location(label0, file$3, 30, 16, 735);
    			attr(input0, "type", "text");
    			input0.className = "form-control";
    			input0.id = "physicalScore";
    			input0.placeholder = "0";
    			input0.value = input0_value_value = ctx.squadatt.physical;
    			add_location(input0, file$3, 31, 16, 797);
    			div1.className = "form-group col-md-4";
    			add_location(div1, file$3, 29, 12, 684);
    			label1.htmlFor = "mentalScore";
    			add_location(label1, file$3, 34, 16, 983);
    			attr(input1, "type", "text");
    			input1.className = "form-control";
    			input1.id = "mentalScore";
    			input1.placeholder = "0";
    			input1.value = input1_value_value = ctx.squadatt.mental;
    			add_location(input1, file$3, 35, 16, 1041);
    			div2.className = "form-group col-md-4";
    			add_location(div2, file$3, 33, 12, 932);
    			label2.htmlFor = "tacticalScore";
    			add_location(label2, file$3, 38, 16, 1223);
    			attr(input2, "type", "text");
    			input2.className = "form-control";
    			input2.id = "tacticalScore";
    			input2.placeholder = "0";
    			input2.value = input2_value_value = ctx.squadatt.tactical;
    			add_location(input2, file$3, 39, 16, 1285);
    			div3.className = "form-group col-md-4";
    			add_location(div3, file$3, 37, 12, 1172);
    			div4.className = "form-row";
    			add_location(div4, file$3, 28, 8, 648);
    			add_location(b1, file$3, 42, 8, 1432);
    			label3.htmlFor = "physicalScore";
    			add_location(label3, file$3, 45, 16, 1555);
    			attr(input3, "type", "text");
    			input3.className = "form-control";
    			input3.id = "physicalScore";
    			input3.placeholder = "0";
    			input3.value = input3_value_value = ctx.missionatt.physical;
    			add_location(input3, file$3, 46, 16, 1617);
    			div5.className = "form-group col-md-4";
    			add_location(div5, file$3, 44, 12, 1504);
    			label4.htmlFor = "mentalScore";
    			add_location(label4, file$3, 49, 16, 1805);
    			attr(input4, "type", "text");
    			input4.className = "form-control";
    			input4.id = "mentalScore";
    			input4.placeholder = "0";
    			input4.value = input4_value_value = ctx.missionatt.mental;
    			add_location(input4, file$3, 50, 16, 1863);
    			div6.className = "form-group col-md-4";
    			add_location(div6, file$3, 48, 12, 1754);
    			label5.htmlFor = "tacticalScore";
    			add_location(label5, file$3, 53, 16, 2047);
    			attr(input5, "type", "text");
    			input5.className = "form-control";
    			input5.id = "tacticalScore";
    			input5.placeholder = "0";
    			input5.value = input5_value_value = ctx.missionatt.tactical;
    			add_location(input5, file$3, 54, 16, 2109);
    			div7.className = "form-group col-md-4";
    			add_location(div7, file$3, 52, 12, 1996);
    			button.className = "btn btn-primary float-right svelte-ww1y1e";
    			add_location(button, file$3, 57, 16, 2294);
    			div8.className = "col-md-12";
    			add_location(div8, file$3, 56, 12, 2246);
    			div9.className = "form-row";
    			add_location(div9, file$3, 43, 8, 1468);
    			add_location(b2, file$3, 60, 8, 2402);
    			label6.htmlFor = "physicalScore";
    			add_location(label6, file$3, 63, 16, 2524);
    			attr(input6, "type", "text");
    			input6.className = "form-control";
    			input6.id = "physicalScore";
    			input6.placeholder = "0";
    			add_location(input6, file$3, 64, 16, 2586);
    			div10.className = "form-group col-md-4";
    			add_location(div10, file$3, 62, 12, 2473);
    			label7.htmlFor = "mentalScore";
    			add_location(label7, file$3, 67, 16, 2746);
    			attr(input7, "type", "text");
    			input7.className = "form-control";
    			input7.id = "mentalScore";
    			input7.placeholder = "0";
    			add_location(input7, file$3, 68, 16, 2804);
    			div11.className = "form-group col-md-4";
    			add_location(div11, file$3, 66, 12, 2695);
    			label8.htmlFor = "tacticalScore";
    			add_location(label8, file$3, 71, 16, 2962);
    			attr(input8, "type", "text");
    			input8.className = "form-control";
    			input8.id = "tacticalScore";
    			input8.placeholder = "0";
    			add_location(input8, file$3, 72, 16, 3024);
    			div12.className = "form-group col-md-4";
    			add_location(div12, file$3, 70, 12, 2911);
    			div13.className = "form-row";
    			add_location(div13, file$3, 61, 8, 2437);
    			add_location(b3, file$3, 75, 8, 3145);
    			div14.className = "card-body svelte-ww1y1e";
    			add_location(div14, file$3, 26, 4, 583);
    			div15.className = "card svelte-ww1y1e";
    			add_location(div15, file$3, 24, 0, 493);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((changed.squadatt) && input0_value_value !== (input0_value_value = ctx.squadatt.physical)) {
    				input0.value = input0_value_value;
    			}

    			if ((changed.squadatt) && input1_value_value !== (input1_value_value = ctx.squadatt.mental)) {
    				input1.value = input1_value_value;
    			}

    			if ((changed.squadatt) && input2_value_value !== (input2_value_value = ctx.squadatt.tactical)) {
    				input2.value = input2_value_value;
    			}

    			if ((changed.missionatt) && input3_value_value !== (input3_value_value = ctx.missionatt.physical)) {
    				input3.value = input3_value_value;
    			}

    			if ((changed.missionatt) && input4_value_value !== (input4_value_value = ctx.missionatt.mental)) {
    				input4.value = input4_value_value;
    			}

    			if ((changed.missionatt) && input5_value_value !== (input5_value_value = ctx.missionatt.tactical)) {
